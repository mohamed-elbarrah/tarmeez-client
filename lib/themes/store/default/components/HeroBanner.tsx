  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-lg space-y-6">
        <span className="inline-block bg-white/20 backdrop-blur-md px-2 py-1 rounded-full text-xs font-bold uppercase">
          وصل حديثاً
        </span>
        ...
        <p className="text-lg opacity-80 leading-relaxed text-slate-100">
          اكتشف أفضل العروض والمنتجات الحصرية في متجرنا اليوم. جودة نضمنها لك في
          كل عملية شراء.
        </p>
        <Link
