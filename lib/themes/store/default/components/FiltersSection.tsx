        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] font-black text-[var(--p-color)]">
                حتى {priceRange} ر.س
              </span>
            </div>
            <input
              ...
              <div className="md:hidden">
                <Sheet>
                  ...
                  <SheetPortal>
                    <SheetContent
                      side="right"
                      className="w-[300px] sm:w-[400px] p-6 text-right"
                      style={
                        {
                          "--p-color": theme.primary,
                          "--s-color": theme.secondary,
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        <div className="space-y-4">
                          ...
                          <div className="flex flex-wrap gap-2 mb-4">
                            {["الكل", ...categories.map((c) => c.name)].map(
                              (cat) => (
                                <button
                                  key={cat}
                                  onClick={() => handleCategoryChange(cat)}
          ...
          {paginatedProducts.length > 0 ? (
            ...
            <div className="bg-white rounded-3xl p-20 text-center border border-dashed border-gray-100">
              ...
              <p className="text-sm text-gray-400 mt-2">
                حاول تقليل قيود الفلاتر أو البحث عن كلمة أخرى.
              </p>
            </div>
          )}
        </div>
