    ...
    <footer className="bg-white border-t border-gray-100 mt-20 pt-16 pb-8 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 text-gray-400"><Facebook size={20} className="hover:text-blue-600"/><Instagram size={20} className="hover:text-pink-600"/><Twitter size={20} className="hover:text-blue-400"/></div>
        </div>
      </div>
