...
export default function CartPage({ theme, cart, onUpdateQty, onRemove, onContinueShopping, onCheckout }: Props) {
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <CartSummary theme={theme} cart={cart} onCheckout={onCheckout} />
      </div>
    </main>
  )
}
