      ...
      <div className="max-w-2xl w-full bg-white p-12 text-center border rounded-2xl shadow-sm">
        ...
        <div className="flex gap-4">
          <Link
            ...
            className="flex-1 px-8 py-4 bg-[var(--p-color)] text-white rounded-xl font-bold hover:shadow-lg transition-all"
          >
            تتبع الطلب
          </Link>
          <Link
            href={`/store/${storeSlug}`}
            className="px-8 py-4 bg-slate-100 rounded-xl font-black text-center hover:bg-slate-200 transition-colors"
          >
            العودة للرئيسية
          </Link>
        </div>
