          ...
          <form className="p-6 md:p-8">
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                />
                <FieldDescription>
                  سنستخدم هذا للتواصل معك. لن نشارك بريدك الإلكتروني مع أي شخص آخر.
                </FieldDescription>
              </Field>
              <Field>
                ...
                <FieldDescription>
                  يجب أن تكون كلمة المرور الخاصة بك 8 أحرف على الأقل.
                </FieldDescription>
              </Field>
              <Field>
              ...
              <Field className="grid grid-cols-3 gap-4">
                ...
                <Button variant="outline" type="button">
                  ...
                  <span className="sr-only">التسجيل باستخدام Meta</span>
                </Button>
              </Field>
              <FieldDescription className="text-center">
                هل لديك حساب بالفعل؟ <Link href="/login">تسجيل الدخول</Link>
              </FieldDescription>
            </FieldGroup>
          </form>
