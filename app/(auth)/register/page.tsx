...
export default function RegisterPage() {
  ...
  const [merchantRegister, { isLoading: isSubmitting }] =
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof MerchantRegisterFormData, string>>
  >({});
  ...
  return (
    <Card className="  shadow-2xl bg-card/50 backdrop-blur-sm w-full max-w-lg mx-auto text-right">
      <CardHeader>
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-left-4 duration-300">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`text-right ${errors.fullName ? "border-destructive" : ""}`}
                />
                {errors.fullName && (
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`text-right ${errors.confirmPassword ? "border-destructive" : ""}`}
                  />
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-left-4 duration-300">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={`flex-row-reverse text-right ${errors.category ? "border-destructive" : ""}`}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={`flex-row-reverse text-right ${errors.country ? "border-destructive" : ""}`}
                    >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="الرياض"
                  className={`text-right ${errors.city ? "border-destructive" : ""}`}
                />
                {errors.city && (
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="أخبرنا عن منتجاتك..."
                  className="max-h-32 text-right"
                  maxLength={300}
                />
              ...
              <div className="flex items-center space-x-2 space-x-reverse pt-2 justify-start">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleSelectChange("agreedToTerms", checked as any)
                  }
                />
                <Label
