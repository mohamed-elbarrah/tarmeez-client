  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <nav className="border-b border-border sticky top-0 bg-white z-50">
        <div className=" containermx-auto px-6 py-4 flex items-center justify-between">
      ...
      {/* Hero Section */}
      <section className=" containermx-auto px-6 py-24 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="inline-flex items-center gap-2 px-2 py-2 bg-secondary rounded-full text-sm">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            منصة شاملة لإنشاء وإدارة المتاجر الإلكترونية مع تحليلات متقدمة
            وتوصيات ذكية لزيادة مبيعاتك
          </p>
          <div className="flex items-center justify-center gap-2">
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-accent text-black hover:bg-accent/90 text-lg px-8 py-6"
              >
                ابدأ متجرك الآن
      ...
      <section id="features" className="py-24 bg-secondary">
        <div className=" containermx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              كل ما تحتاجه لنجاح متجرك
            </h2>
            <p className="text-xl text-muted-foreground">
              أدوات قوية ومتكاملة لإدارة تجارتك الإلكترونية
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "توصيات ذكية لتحسين المبيعات وتجربة العملاء بناءً على سلوك الزوار",
              },
              {
                icon: <BarChart3 className="w-6 h-6" />,
                title: "تحليلات شاملة",
                description:
                  "تتبع دقيق للمبيعات والزوار ومعدلات التحويل مع رؤى قابلة للتنفيذ",
              },
              {
              ...
              },
              {
                ...
                title: "إدارة متكاملة",
                description:
                  "إدارة المنتجات والطلبات والعملاء من لوحة تحكم واحدة",
              },
              {
        ...
        <div className=" containermx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-2 py-2 bg-accent/10 rounded-full text-sm">
                <Sparkles className="w-4 h-4 text-accent" />
                <span>مدعوم بالذكاء الاصطناعي</span>
              </div>
              <h2 className="text-4xl font-bold">
                توليد صفحات هبوط احترافية تلقائياً
              </h2>
              <p className="text-xl text-muted-foreground">
                اترك الذكاء الاصطناعي يصمم صفحات منتجات عالية التحويل بناءً على
                أفضل الممارسات والبيانات التحليلية
              </p>
                  ...
                  <div className="p-4 bg-secondary rounded-lg">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className="aspect-square bg-accent/20 rounded"
                        ></div>
                      ))}
                    </div>
                  </div>
      ...
      <section className="py-24 bg-secondary">
        <div className=" containermx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4">تكامل مع أدواتك المفضلة</h2>
          <p className="text-xl text-muted-foreground mb-12">
            اتصل بسهولة مع منصات الدفع والشحن والتسويق
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "بوابات الدفع",
                items: ["مدى", "فيزا", "ماستركارد", "Apple Pay"],
              },
              {
                title: "شركات الشحن",
                items: ["أرامكس", "سمسا", "DHL", "فيديكس"],
              },
              {
                title: "أدوات التسويق",
                items: [
      ...
      <section id="pricing" className="py-24">
        <div className=" containermx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              ابدأ مجاناً ثم قم بالترقية عند الحاجة
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                {plan.popular && (
                  <div className="bg-accent text-black text-sm font-bold px-2 py-1 rounded-full inline-block mb-4">
                    الأكثر شعبية
                  </div>
                )}
