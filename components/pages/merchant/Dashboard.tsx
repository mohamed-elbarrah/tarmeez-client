          ...
          <div className="flex-1">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm">
                  <strong>زيادة المبيعات:</strong> لاحظنا أن الزوار الذين
                  يشاهدون صفحة "ساعة ذكية برو" لديهم معدل تحويل أعلى بنسبة 34%.
                  نقترح زيادة الحملات التسويقية لهذا المنتج.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
                <p className="text-sm">
                  <strong>استهداف أفضل:</strong> معظم عملائك يزورون المتجر بين
                  الساعة 8-10 مساءً. فكر في جدولة إعلاناتك خلال هذه الفترة.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
                <p className="text-sm">
                  <strong>تحسين التحويل:</strong> إضافة صور إضافية للمنتجات قد
                  تزيد معدل التحويل بنسبة 18% حسب البيانات التحليلية.
                </p>
              </div>
            </div>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          {topProducts.map((product, i) => (
            <div
              key={i}
              className="flex items-center gap-2 p-4 bg-secondary rounded-lg hover:shadow-sm transition-shadow"
            >
