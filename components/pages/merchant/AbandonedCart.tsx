          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-right py-4 px-4 text-sm font-medium text-muted-foreground">القيمة</th>
            ...
            <tbody>
              {[
                { customer: "أحمد محمد", email: "ahmad@example.com", items: 3, value: "450 ر.س", date: "منذ ساعة" },
                { customer: "فاطمة علي", email: "fatima@example.com", items: 2, value: "320 ر.س", date: "منذ ساعتين" },
                { customer: "محمد خالد", email: "mohammed@example.com", items: 1, value: "180 ر.س", date: "منذ 3 ساعات" },
              ].map((cart, i) => (
                <tr key={i} className="border-b border-border">
                  ...
                  <td className="py-4 px-4">{cart.items} منتج</td>
                  <td className="py-4 px-4 font-medium">{cart.value}</td>
                  <td className="py-4 px-4 text-muted-foreground">{cart.date}</td>
                  <td className="py-4 px-4">
