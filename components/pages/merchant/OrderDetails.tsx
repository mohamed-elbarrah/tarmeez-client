          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {order.items.map((item: any, i: number) => (
                <div
                  key={i}
                  className="flex items-center gap-2 pb-4 border-b border-border last:border-0"
                >
            ...
            <div className="space-y-4">
              ...
              {Object.keys(statusConfig)
                .filter((s) => {
                  ...
                  return (
                    orderList.indexOf(s) <= currentIndex &&
                    orderList.indexOf(s) !== -1
                  );
                })
                .reverse()
                .map((statusKey, i) => {
                  ...
                  return (
                    <div key={i} className="flex gap-2">
                      <div className="flex flex-col items-center">
                        <div
                          className={`w-3 h-3 rounded-full ${i === 0 ? "bg-accent" : "bg-secondary"}`}
                        ></div>
                        {i < 4 && (
              ...
              <div className="pt-3 border-t border-border">
                ...
                {order.transactionId && (
                  <div className="text-sm text-accent mt-1">
                    رقم المعاملة: {order.transactionId}
                  </div>
                )}
              </div>
            </div>
