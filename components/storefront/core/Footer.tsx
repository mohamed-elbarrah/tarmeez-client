      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-black text-(--p-color)">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            منصتك المتكاملة لأفضل المنتجات العالمية بأسعار تنافسية. جودة نضمنها
            لك في كل عملية شراء.
          </p>
        </div>
        <div>
          <h4 className="font-bold mb-4 text-(--p-color) uppercase tracking-tighter">
            روابط سريعة
          </h4>
          <ul className="text-sm text-gray-500 space-y-2 cursor-pointer">
            <li>
              <Link href={`/store/${storeSlug}`}>الرئيسية</Link>
            </li>
            <li>
              <Link href={`/store/${storeSlug}/products`}>المتجر</Link>
            </li>
            <li>تواصل معنا</li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="font-bold text-(--p-color) uppercase tracking-tighter">
            تابعنا
          </h4>
